        ...
        <div class="row">
            ...
            <div class="clearfix">
                ...
                <article class="col-md-4 col-sm-6 col-xs-12 clearfix wow fadeInUp" data-wow-duration="500ms">
                    <div class="post-block">
                        <div class="media-wrapper">
                            <img src="/img/app-main/blog/blog-post-1.jpg" alt="amazing caves coverimage" class="img-responsive">
                        </div>
                        <div class="content">
                ...
                <article class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="200ms">
                    <div class="post-block">
                        <div id="gallery-post" class="media-wrapper">
                            <div class="item">
                                <img src="/img/app-main/blog/blog-post-1.jpg" alt="blog post" class="img-responsive">
                            </div>
                            <div class="item">
                                <img src="/img/app-main/blog/blog-post-3.jpg" alt="blog post" class="img-responsive">
                            </div>
                            <div class="item">
                                <img src="/img/app-main/blog/blog-post-2.jpg" alt="blog post | Meghna" class="img-responsive">
                            </div>
                        </div>
                ...
                <article class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="400ms">
                    <div class="post-block">
                        <div class="media-wrapper">
                            <img src="/img/app-main/blog/blog-post-6.jpg" alt="amazing caves coverimage" class="img-responsive">
                        </div>
