<a href="#" class="badge badge-secondary" data-toggle="modal" data-target="#EpicIDHelpModal">?</a>
<!-- Modal -->
<div class="modal fade" id="EpicIDHelpModal" tabindex="-1" aria-labelledby="epicIDHelpModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="epicIDHelpModalLabel">How to Find Your Epic ID</h5>
