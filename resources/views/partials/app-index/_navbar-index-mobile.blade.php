            ...
            <div id="mobile_collapse_4" class="collapse mobile-bar-item__body">
                <div class="mobile-bar-item__inner">
                    <ul class="widget-partners-mobile-carousel">
                        <li>
                            <img src="img/app/samples/partner-carousel-img-01.png" alt="">
                        </li>
                        <li>
                            <img src="img/app/samples/partner-carousel-img-02.png" alt="">
                        </li>
                        <li>
                            <img src="img/app/samples/partner-carousel-img-03.png" alt="">
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="match-score-inline__body-inner">
                            <figure class="match-team" role="group">
                                <figure class="match-team-logo match-team-logo--team-1" role="group">
                                    <img src="img/app/samples/logo-necromancers-30.png" srcset="img/app/samples/logo-necromancers-30@2x.png 2x" alt="NCR Logo">
                                </figure>
                                <figcaption>
                        ...
                        <div class="match-score-inline__body-inner">
                            <figure class="match-team" role="group">
                                <figure class="match-team-logo match-team-logo--team-2" role="group">
                                    <img src="img/app/samples/logo-rhinos-30.png" srcset="img/app/samples/logo-rhinos-30@2x.png 2x" alt="RRH Logo">
                                </figure>
                                <figcaption>
                            ...
                            <li>
                                <a href="matches-overview-1.html">
                                    <svg role="img" class="df-icon df-icon--overview">
                                        <use xlink:href="img/app/necromancers.svg#overview"/>
                                    </svg>
                                </a>
                            </li>
                            <li>
                                <a href="matches-stats-1.html">
                                    <svg role="img" class="df-icon df-icon--stats">
                                        <use xlink:href="img/app/necromancers.svg#stats"/>
                                    </svg>
                                </a>
                            </li>
                            <li>
                                <a href="matches-lineups-1.html">
                                    <svg role="img" class="df-icon df-icon--lineups">
                                        <use xlink:href="img/app/necromancers.svg#lineups"/>
                                    </svg>
                                </a>
                            </li>
                            <li>
                                <a href="matches-replay.html">
                                    <svg role="img" class="df-icon df-icon--replay">
                                        <use xlink:href="img/app/necromancers.svg#replay"/>
                                    </svg>
                                </a>
                            </li>
                        </ul>
                        ...
                        <div class="match-score-inline__body-inner">
                            <figure class="match-team" role="group">
                                <figure class="match-team-logo match-team-logo--team-5" role="group">
                                    <img src="img/app/samples/logo-eagles-30.png" srcset="img/app/samples/logo-eagles-30@2x.png 2x" alt="FEG Logo">
                                </figure>
                                <figcaption>
                        ...
                        <div class="match-score-inline__body-inner">
                            <figure class="match-team" role="group">
                                <figure class="match-team-logo match-team-logo--team-3" role="group">
                                    <img src="img/app/samples/logo-bulls-30.png" srcset="img/app/samples/logo-bulls-30@2x.png 2x" alt="AGB Logo">
                                </figure>
                                <figcaption>
                        ...
                        <div class="match-score-inline__body-inner">
                            <figure class="match-team" role="group">
                                <figure class="match-team-logo match-team-logo--team-4" role="group">
                                    <img src="img/app/samples/logo-panthers-30.png" srcset="img/app/samples/logo-panthers-30@2x.png 2x" alt="ICP Logo">
                                </figure>
                                <figcaption>
